...
@implementation ATContactPicker
@synthesize groups, groupTitles, delegate;
...
{
    [super viewDidLoad];
    self.title = ATLocalizedString(@"Groups", nil);
...
{
    ATContactPickerList *contactPickerList = [[ATContactPickerList alloc] initWithStyle:UITableViewStylePlain contacts:[self.groups objectAtIndex:indexPath.row]];
